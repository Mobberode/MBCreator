...
##Mobs
#Zombie
execute at @e[type=minecraft:area_effect_cloud,tag=zs.zombiespawn] run particle minecraft:item{item:{id:"minecraft:rotten_flesh"}} ~ ~ ~ 0.2 0.1 0.2 0 10 normal @a[tag=!zsct.eparticles_disabled]
#Skeleton
execute at @e[type=minecraft:area_effect_cloud,tag=zs.skeletonspawn] run particle minecraft:item{item:{id:"minecraft:arrow"}} ~ ~ ~ 0.2 0.1 0.2 0 15 normal @a[tag=!zsct.eparticles_disabled]
#Spider
execute at @e[type=minecraft:area_effect_cloud,tag=zs.spiderspawn] run particle minecraft:item{item:{id:"minecraft:cobweb"}} ~ ~ ~ 0.15 0.1 0.15 0 20 normal @a[tag=!zsct.eparticles_disabled]
#Wither Skeleton
...
execute at @e[type=minecraft:area_effect_cloud,tag=zs.pillagerspawn] run particle minecraft:item{item:{id:"arrow"}} ~ ~ ~ 0.2 0.1 0.2 0 15 normal @a[tag=!zsct.eparticles_disabled]
#Witch
...
#Husk
execute at @e[type=minecraft:area_effect_cloud,tag=zs.huskspawn] run particle minecraft:dust{color:[1.0,0.847,0.239],scale:1.5} ~ ~ ~ 0.2 0.1 0.2 0 3 normal @a[tag=!zsct.eparticles_disabled]
#Stray
execute at @e[type=minecraft:area_effect_cloud,tag=zs.strayspawn] run particle minecraft:item{item:{id:"arrow"}} ~ ~ ~ 0.2 0.1 0.2 0 15 normal @a[tag=!zsct.eparticles_disabled]
...
#Silverfish
execute at @e[type=minecraft:area_effect_cloud,tag=zs.silverfishspawn] run particle minecraft:item{item:{id:"cracked_stone_bricks"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
#Cave Spider
...
execute at @e[type=minecraft:area_effect_cloud,tag=zs.vindicatorspawn] run particle minecraft:item{item:{id:"iron_axe"}} ~ ~ ~ 0.2 0.1 0.2 0 15 normal @a[tag=!zsct.eparticles_disabled]
#Charged Creeper
...
#Piglin Brute
execute at @e[type=minecraft:area_effect_cloud,tag=zs.piglin.brutespawn] run particle minecraft:item{item:{id:"minecraft:gold_ingot"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
...
#Magma Cube
execute at @e[type=minecraft:area_effect_cloud,tag=zs.magma.cubespawn] run particle minecraft:item{item:{id:"minecraft:magma_cream"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
...
#Wither
execute at @e[type=minecraft:area_effect_cloud,tag=zs.witherspawn] run particle minecraft:item{item:{id:"minecraft:wither_rose"}} ~ ~ ~ 0 0.1 0 0.075 25 normal @a[tag=!zsct.eparticles_disabled]
#Warden
...
#Iron Golem
execute at @e[type=minecraft:area_effect_cloud,tag=zs.iron.golemspawn] run particle minecraft:item{item:{id:"minecraft:iron_ingot"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
#Snow Golem
...
#Hoglin
execute at @e[type=minecraft:area_effect_cloud,tag=zs.hoglinspawn] run particle minecraft:item{item:{id:"minecraft:porkchop"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
execute at @e[type=minecraft:area_effect_cloud,tag=zs.hoglinspawn] run particle minecraft:item{item:{id:"minecraft:crimson_fungus"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
#Piglin
execute at @e[type=minecraft:area_effect_cloud,tag=zs.piglinspawn] run particle minecraft:item{item:{id:"minecraft:gold_ingot"}} ~ ~ ~ 0 0.1 0 0.05 20 normal @a[tag=!zsct.eparticles_disabled]
#Ender Dragon
