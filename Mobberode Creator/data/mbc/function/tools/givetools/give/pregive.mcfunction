...
##Hotbar Switcher
item replace entity @p inventory.18 with trial_key[custom_data={"mbc.action":prev},custom_name='{"text":"Previous Page","color":"#e85d00","bold":true,"italic":false}',lore=['[{"text":"["},{"keybind":"key.swapOffhand","color":"blue"},{"text":"]"}]']]
item replace entity @p inventory.19 with ominous_trial_key[custom_data={"mbc.action":next},custom_name='{"text":"Next Page","color":"aqua","bold":true,"italic":false}',lore=['[{"text":"["},{"keybind":"key.swapOffhand","color":"blue"},{"text":"]"}]']]